...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_7__["default"])(state);
...
const drop = () => {
  ...
  function unhighLight(item) {
    ...
    } else if (item.getAttribute('data-first') === 'true') {
  ...
  fileInputs.forEach(input => {
    ...
    if (input.getAttribute('data-first') === 'true') {
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["postOnlyImg"])(input, 'drop');
    }
  });
};
...
const filter = () => {
  ...
  menu.addEventListener('click', e => {
    let target = e.target;
    let currClass = target.classList[0];
    let allElem = wrapper.querySelectorAll(`.${currClass}`);
    typeFilter(allElem);
...
const forms = state => {
  ...
  upload.forEach(item => {
    if (item.getAttribute('data-first') === 'true') {
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_1__["postOnlyImg"])(item, 'input');
    }
  });
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      if (item.classList.contains('calc_form')) {
        state.price = document.querySelector('.calc-price').textContent;
...
const modals = () => {
  ...
  } // убираем дергание скрола при body : overflow
...
const scrolling = upSelector => {
  ...
  }); // Scrolling with Request animation frames
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: postData, getResource, postOnlyImg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postOnlyImg", function() { return postOnlyImg; });
/* harmony import */ var core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.promise.finally */ "./node_modules/core-js/modules/es.promise.finally.js");
/* harmony import */ var core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_0__);
...
const postOnlyImg = (item, event) => {
  item.addEventListener(event, () => {
    ...
    postData('assets/server.php', data).then(res => {
      console.log(res);
